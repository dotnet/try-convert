...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static IEnumerable<Diagnostic> GetSortedDiagnostics(string[] sources, string language, DiagnosticAnalyzer analyzer)
        {
        ...
        /// <returns>An IEnumerable of Diagnostics that surfaced in the source code, sorted by Location</returns>
        protected static IEnumerable<Diagnostic> GetSortedDiagnosticsFromDocuments(DiagnosticAnalyzer analyzer, Document[] documents)
        {
            ...
            {
                if (!(project.GetCompilationAsync().Result is Compilation comp)) continue;
